...
rfc = RandomForestClassifier(n_estimators=200,max_samples=0.7,max_depth=7,criterion='entropy',ccp_alpha=0.1)
...
pickle.dump(rfc, open('Random_Forest_Classifier_NFS.pkl','wb'))
...
accuracy_train = cross_val_score(rfc, X_train, Y_train, cv=5)
