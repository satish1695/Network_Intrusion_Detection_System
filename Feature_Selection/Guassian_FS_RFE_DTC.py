...
NBG = GaussianNB()
NBG.fit(X_train_rfe_dtc_df, Y_train)
Y_pred_nbg=NBG.predict(X_test_rfe_dtc_df)
...
pickle.dump(NBG, open('Guassian_FS_RFE_DTC.pkl','wb'))
...
accuracy_train = cross_val_score(NBG, X_train_rfe_dtc_df, Y_train, cv=5)
