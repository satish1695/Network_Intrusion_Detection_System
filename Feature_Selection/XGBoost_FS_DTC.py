...
xgbc.fit(X_train_dtc_df, Y_train)
Y_pred_xgbc=xgbc.predict(X_test_dtc_df)
...
pickle.dump(xgbc, open('XGBoost_FS_DTC.pkl','wb'))
...
accuracy_train = cross_val_score(xgbc, X_train_dtc_df, Y_train, cv=5)
