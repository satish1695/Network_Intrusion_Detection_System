...
dtc.fit(X_train_dtc_df, Y_train)
Y_pred_dtc=dtc.predict(X_test_dtc_df)
...
pickle.dump(dtc, open('Decision_Tree_Classifier_FS_DTC.pkl','wb'))
...
accuracy_train = cross_val_score(dtc, X_train_dtc_df, Y_train, cv=5)
