...
gdcv.fit(X_train_rfe_dtc_df, Y_train)
...
neigh.fit(X_train_rfe_dtc_df, Y_train)
Y_pred_knn=neigh.predict(X_test_rfe_dtc_df)
...
pickle.dump(neigh, open('K_Nearest_Neighbor_FS_RFE_DTC.pkl','wb'))
...
accuracy_train = cross_val_score(neigh, X_train_rfe_dtc_df, Y_train, cv=5)
