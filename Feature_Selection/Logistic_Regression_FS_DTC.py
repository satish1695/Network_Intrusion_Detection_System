...
logisticRegr.fit(X_train_dtc_df, Y_train)
Y_pred_lr=logisticRegr.predict(X_test_dtc_df)
...
pickle.dump(logisticRegr, open('Logistic_Regression_FS_DTC.pkl','wb'))
...
accuracy_train = cross_val_score(logisticRegr, X_train_dtc_df, Y_train, cv=5)
