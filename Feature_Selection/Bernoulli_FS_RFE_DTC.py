...
NBB = BernoulliNB()
NBB.fit(X_train_rfe_dtc_df, Y_train)
Y_pred_nbb=NBB.predict(X_test_rfe_dtc_df)
...
pickle.dump(NBB, open('Bernoulli_FS_RFE_DTC.pkl','wb'))
...
accuracy_train = cross_val_score(NBB, X_train_rfe_dtc_df, Y_train, cv=5)
