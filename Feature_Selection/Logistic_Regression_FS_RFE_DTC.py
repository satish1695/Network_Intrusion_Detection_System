...
logisticRegr.fit(X_train_rfe_dtc_df, Y_train)
Y_pred_lr=logisticRegr.predict(X_test_rfe_dtc_df)
...
pickle.dump(logisticRegr, open('Logistic_Regression_FS_RFE_DTC.pkl','wb'))
...
accuracy_train = cross_val_score(logisticRegr, X_train_rfe_dtc_df, Y_train, cv=5)
